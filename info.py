...
API_ID = int(environ.get('API_ID', '26264369')) # API ID from my.telegram.org
API_HASH = environ.get('API_HASH', 'cff042e35804f2a09fdd8d66542a4936')  # API Hash from my.telegram.org
BOT_TOKEN = environ.get('BOT_TOKEN', "8347279245:AAH5KNgEoZxr3mqKwqIXOq01q-J8dPwutdQ")    # Bot token from @BotFather
...
PICS = (environ.get('PICS', 'https://envs.sh/4Rr.jpg')).split()  # Sample pic
...
# ============================
ADMINS = [int(admin) if id_pattern.search(admin) else admin for admin in environ.get('ADMINS', '1179468118').split()] # Replace with the actual admin ID(s) to add
...
LOG_CHANNEL = int(environ.get('LOG_CHANNEL', '-1003705894952'))  # Log channel id (make sure bot is admin)
BIN_CHANNEL = int(environ.get('BIN_CHANNEL', '-1002324815999'))  # Bin channel id (make sure bot is admin)
...
# ============================
DATABASE_URI = environ.get('DATABASE_URI', "mongodb+srv://aravindguru996:JrLXt0PhZ1YyW5o2@cluster0.n8rps.mongodb.net/?retryWrites=true&w=majority&appName=Cluster0")  # MongoDB URI for the database
...
# ============================
GRP_LNK = environ.get('GRP_LNK', 'https://t.me/Akdissertation') # Group link for the bot
